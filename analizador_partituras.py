...
#             print("💡 Instala Audiveris siguiendo las instrucciones oficiales")
#             return False
#         return True
...
#                 return output_path
#             else:
#                 print(f"❌ Error: No se generó el archivo MXL")
#                 if result.stderr:
#                     print(f"Error de Audiveris: {result.stderr}")
#                 return None
...
#                         print(f"   🗑️  Eliminado: {archivo_temp.name}")
#                     except Exception as e:
#                         print(f"   ⚠️  Error eliminando {archivo_temp.name}: {e}")
...
#                 except Exception as e:
#                     print(f"   ⚠️  Error eliminando {log_file.name}: {e}")
            
#             if archivos_eliminados:
#                 print(f"✅ Limpieza completada. {len(archivos_eliminados)} archivos eliminados.")
#             else:
#                 print("ℹ️  No se encontraron archivos temporales para eliminar.")
